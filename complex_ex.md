...
```math
MissionE: \diamondsuit \square b_1 \wedge b_2 \vee \diamondsuit \square b_3 \wedge b_6 \vee  \diamondsuit \square b_4 \wedge b_5 \vee \wedge \diamondsuit ((b_1 \vee b_3 \vee b_4) \wedge \circle \diamondsuit b_9) \vee (\diamondsuit \square ((b_{11} \vee b_7) \wedge \diamondsuit \circle (b_{10} \vee b_{12})))
```
```math
MissionF \diamondsuit \square b_1 \wedge b_2 \vee \diamondsuit \square b_3 \wedge b_6 \vee  \diamondsuit \square b_4 \wedge b_5 \vee \wedge \diamondsuit ((b_1 \vee b_3 \vee b_4) \wedge \circle \diamondsuit b_9) \vee  (\diamondsuit \square ((b_{11} \vee b_7)
```
