 ...
 * The **shadow net files** (.sns) include all the information to run an experiment without having Renew opened, by using the command line:
   ```
   java -jar "Installation path of Renew\loader.jar" startsimulation FileName.sns execute_experiment
   ```
